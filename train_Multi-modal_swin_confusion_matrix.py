...
from may_val_pair_unpair_confusion_matrix import test
from swin_my_v3 import net
...
trainloader = torch.utils.data.DataLoader(train_data, batch_size=30, shuffle=True,  num_workers=4)
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        if i % 1000 == 2:
            ...
            if (epoch ==0 or epoch == 1) and i>1:
                model_file = "/home/shoaibmerajsami/Desktop/atr hadi final/Multi_modal_swin_GRN_DSIAC/ResNet50_image72_20_Epoch_99_99.pth"
                print(model_file)
                checkpoint1 =torch.load("/home/shoaibmerajsami/Desktop/atr hadi final/Multi_modal_swin_GRN_DSIAC/ResNet50_image72_20_Epoch_99_99.pth")
