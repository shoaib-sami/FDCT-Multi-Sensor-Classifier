...
from my_resnetA import model
from may_val import test
#root_dir = "/home/shoaibmerajsami/Desktop/UCHE/PycharmProjects/abc/"
root_dir = '/media/shoaibmerajsami/SMS/ATR_database_october_2021/cycle_gan_july_2022_final/august_25th_2022/pytorch-CycleGAN-and-pix2pix-master/results/MtoV66_9_all_MWIR_train_Visible/test_latest/images/'
...
for epoch in range(800):
    ...
    model_file = "ResNet18_synthetic_image72_%d_Epoch.pth" % (epoch + 6)
    print(model_file)
