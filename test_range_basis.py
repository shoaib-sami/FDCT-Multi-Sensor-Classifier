...
def test(model):
    root_dir = '/home/shoaibmerajsami/Desktop/atr hadi final/66_chip/synthetic_visible_nce_cycle/fake_B/'#/home/shoaibmerajsami/Desktop/atr hadi final/cycle_gan_generated_image/August_10_genA_vis/'#"/home/shoaibmerajsami/Desktop/atr hadi final/cycle_gan_generated_image/July_31_gen_A_no_Cls/mwToGenA_vis_val_set_41k/GenA/"
    ...
    trainloader = torch.utils.data.DataLoader(train_data, batch_size=450, shuffle=True, num_workers=4)
    ...
    plt.title('Visible Synthetic Test Set')
    plt.ylabel('Actual')
    plt.xlabel('Predicted')
    plt.savefig('Visible_nce_Cyclegan.png', bbox_inches='tight')
    plt.show(block=False)
    fig1, ax1 = plt.subplots(figsize=(10,10))
    sns.heatmap(cmn, annot=True, fmt='.3f', xticklabels=target_names, yticklabels=target_names)
    plt.title('Visible Synthetic Test Set (Normalized Confusion Matrix)')
    plt.ylabel('Actual')
    plt.xlabel('Predicted')
    plt.savefig('Visible_total_normalized_nce_cyclegan.png', bbox_inches='tight')
    plt.show(block=False)
...
# Loss and optimizer
model.load_state_dict(torch.load('/media/shoaibmerajsami/SMS/ATR_database_october_2021/cycle_gan_july_2022_final/august_25th_2022/pytorch-CycleGAN-and-pix2pix-master/models/Visible_66_image_ResNet18_5_Epoch99_28.pth')["model"])
model = model.cuda()
