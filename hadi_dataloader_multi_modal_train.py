...
class YourDataset(Dataset):
    def __init__(self, img_dir, transform=None):
        self.img_dir = '/home/shoaibmerajsami/Desktop/atr hadi final/Multi_domain_fusion/dataset/train_vis/'
    ...
    def __getitem__(self, index):
        ...
        image_abs_dir_mwir = image_abs_dir.replace('train_vis','train_mwir')
                                                                    ...
                                                                    if os.path.exists(image_abs_dir_mwir):
                                                                        ...
                                                                        if os.path.exists(image_abs_dir_mwir):
                                                                            ...
                                                                            if os.path.exists(image_abs_dir_mwir):
                                                                                ...
                                                                                aaa2 = aaa.split("_")[-1]
                                                                                aaa2_string = aaa2 + '.png'
                                                                                aaa3 =str(int(aaa2)+9)+'.png'
                                                                                image_abs_dir_mwir = image_abs_dir_mwir.replace(aaa2_string,aaa3)
                                                                                   

        try:
            img = Image.open(image_abs_dir).convert("RGB")
            #img = img
