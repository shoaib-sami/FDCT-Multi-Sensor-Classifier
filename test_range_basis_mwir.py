...
def test(model):
    root_dir = '/home/shoaibmerajsami/Desktop/atr hadi final/MW_NVESD/test/'#'/home/shoaibmerajsami/Desktop/UCHE/PycharmProjects/abc_test_2/'#'/home/shoaibmerajsami/Desktop/atr hadi final/Sig_3_class/68_reshape_original/' #'/home/shoaibmerajsami/Desktop/atr hadi final/Sig_3_class/' #'/home/shoaibmerajsami/Desktop/atr hadi final/66_chip/mwir/mwir_ttv_66_chip/test_distance_basis/5000/'#/home/shoaibmerajsami/Desktop/atr hadi final/cycle_gan_generated_image/August_10_genA_vis/'#"/home/shoaibmerajsami/Desktop/atr hadi final/cycle_gan_generated_image/July_31_gen_A_no_Cls/mwToGenA_vis_val_set_41k/GenA/"
    ...
    trainloader = torch.utils.data.DataLoader(train_data, batch_size=25, shuffle=True, num_workers=4)
    ...
    plt.savefig('MWIR_2022_december.png', bbox_inches='tight')
...
# Loss and optimizer
model.load_state_dict(torch.load('/media/shoaibmerajsami/SMS/ATR_database_october_2021/cycle_gan_july_2022_final/query-MoNCE/MWIR_66_image_ResNet18_6_Epoch_Accuracy_99_62.pth')["model"])
model = model.cuda()
